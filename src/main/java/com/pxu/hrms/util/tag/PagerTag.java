...
//            Others info
            ...
            res.append("&nbsp; 跳转到 &nbsp;&nbsp;<input style='text-align:center;BORDER_RIGHT: #aaaadd 1px solid;PADDING-RIGHT:5px; BORDER-TOP: #aaaadd 1px solid; PADDING-LEF:5px; PADDING-BOTTOM:2px; MARGIN:2px; BORDER-LEFT:#aaaadd 1px solid; COLOR: #000099; PADDING-TOP:2px; BORDER-BOTTOM: #aaaadd 1px solid; TEXT-DECORATION: none' type='text' size='2' id='pager_jump_page_size'/>");
            ...
            res.append("    }else{");
            res.append("        var submin_url='" + this.submitUrl + "';");
